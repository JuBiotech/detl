...
columnmapping = {
    ...
    'pump_b_rate_sp': 'FB\\d\\.SV',
    'pump_b_rate_pv': 'FB\\d\\.PV',
    'pump_b_volume_pv': 'VB\\d\\.PV',
    'pump_c_rate_sp': 'FC\\d\\.PV',
    'pump_c_rate_pv': 'FC\\d\\.SP',
    'pump_c_volume_pv': 'VC\\d\\.PV',
    'pump_d_rate_sp': 'FD\\d\\.PV',
    'pump_d_rate_pv': 'FD\\d\\.SP',
...
class DASware5Parser(core.DASwareParser):
    def parse(self, filepath:pathlib.Path) -> core.DWData:
        ...
        for _, reactor in dd.items():
            reactor._dataframe = common.transform_trackdata(reactor.trackdata, timeshift_in_min, columnmapping, core.DASwareVersion.V5)
